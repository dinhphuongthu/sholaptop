...
public class ChiTietSanPhamMoiNhat extends AppCompatActivity implements SanPhamTheoLoaiadapter.SelectedProduct {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chi_tiet_san_pham_moi_nhat);
            ...
            public void onClick(View v) {
                ...
                if(MainActivity.listGioHang.size()>0){
                    ...
                    if(exists==false){
                        ...
                        MainActivity.listGioHang.add(new com.listview.shoplaptop.model.GioHang(Id,Name,giamoi,Image,soluong));
                    }
                }else{
                    int soluong =Integer.parseInt(spinner.getSelectedItem().toString());
                    long giamoi=soluong * Giachitiet;
